...
<form class="layui-form" action="/adduser" lay-filter="example">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
    <select name="rname" id="rname" lay-verify="required" lay-filter="xmFilter">
        <option value=""></option>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <select name="sex" id="sex" lay-verify="required" lay-filter="xmFilter">
        ...
        $.ajax({
            ...
            success: function (data) {
                $.each(data, function (index, item) {
                    $('#rname').append(new Option(item.name, item.id));// 下拉菜单里添加元素
                });
